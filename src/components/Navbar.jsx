            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-10">
                    <a href="#home" className="relative text-white/80 transition duration-300 hover:text-purple-500 group">
                        ...
                        <span className="absolute left-0 -bottom-1 w-0 h-0.5 bg-purple-500 transition-all duration-300 group-hover:w-full">
                        </span>
                    </a>
                    ...
                    <a href="#Work" className="relative text-white/80 transition duration-300 hover:text-purple-500 group">
                ...
                {
                    showMenu && (
                        <div className="md:hidden fixed top-20 left-0  w-full bg-dark-300 min-h-screen rounded-lg p-4 flex flex-col space-y-4 text-center justify-center z-50">
                    ...
                    <a  onClick={() => setShowMenu(!showMenu)} href="#Projects" className="relative text-white/80 transition duration-300 hover:text-purple-500 group">
                        <span>Projects</span>
